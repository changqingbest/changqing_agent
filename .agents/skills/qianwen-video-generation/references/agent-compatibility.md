# Agent Compatibility — qianwen-video-generation
...
|-------|-----------------|---------------|
| qianwen-video-generation | generate video, animation, text-to-video, image-to-video | `{base}/qianwen-video-generation/SKILL.md` |
